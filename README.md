...
6. (03/11) Added 2008 county voter registration and precint variables. Fixed issue where 2008 county unemployment was removed from finald data. Uploaded updated R scripts incorporating these changes.
